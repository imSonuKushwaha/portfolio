...
const Academic = () => {
  return (
    <>
      ...
      <div className="relative h-96 lg:h-[500px] md:h-[600px] w-full flex justify-center items-center text-5xl font-bold text-orange-100 bg-[#44494F] tracking-widest transition-all ease-in-out delay-150 duration-700 hover:bg-transparent hover:-translate-y-40 hover:opacity-0 ">
        ACADEMICS
      </div>
    </>
  );
