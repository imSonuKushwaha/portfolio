...
const Experience = () => {
  return (
    <>
      ...
      <div className="relative h-[600px] lg:h-[800px] md:h-[1000px] w-full flex flex-col justify-center items-center gap-2 bg-[#44494F] transition-all ease-in-out delay-150 duration-700 hover:bg-transparent hover:tracking-extreme hover:opacity-0">
